...
export function ProvidersList() {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-accent-orange-50 dark:bg-red-900/10 border-2 border-accent-orange-300 dark:border-red-800 rounded-lg p-4 text-center">
        <div className="space-y-2 text-sm">
          <div>
            <p className="text-gray-700 dark:text-gray-300 mb-2 text-md">
              <strong>Need Immediate Assistance?</strong> Speak with an
              advocate, text or call this 24 hour confidential hotline:
            </p>
            <div className="flex flex-wrap gap-3 items-center justify-center">
              <Link
                href="tel:505-473-5200"
                className="inline-block px-4 py-1 bg-red-400 hover:bg-red-700 text-white font-medium rounded transition-colors"
              >
                505-473-5200
              </Link>
              <span className="text-gray-600 dark:text-gray-400">or</span>
              <Link
                href="tel:800-473-5220"
                className="inline-block px-4 py-1 bg-red-400 hover:bg-red-700 text-white font-medium rounded transition-colors"
              >
                800-473-5220
              </Link>
          ...
          <p className="text-gray-600 dark:text-gray-400 mt-3">
            ...
            <Link
              href="https://esperanzashelter.org/programs-services/"
              target="_blank"
              rel="noopener noreferrer"
              className="text-orange-600 dark:text-orange-400 hover:underline"
            >
              Esperanza Shelter Programs & Services
            </Link>
          </p>
        </div>
      </div>
